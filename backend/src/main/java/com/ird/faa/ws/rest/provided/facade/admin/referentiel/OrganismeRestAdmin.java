...
import com.ird.faa.service.admin.facade.formulaire.OrganismeAdminService;
...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.OrganismeConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.OrganismeVo;

@Api("Manages organisme services")
@RestController
@RequestMapping("api/admin/organisme")
public class OrganismeRestAdmin {

@Autowired
private OrganismeAdminService organismeService;
