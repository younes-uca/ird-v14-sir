...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.CultureScientifiqueRecontreGrandPublicJeunePublicConverter;
...
@RestController
@RequestMapping("api/chercheur/cultureScientifiqueRecontreGrandPublicJeunePublic")
public class CultureScientifiqueRecontreGrandPublicJeunePublicRestChercheur {
...
private CultureScientifiqueRecontreGrandPublicJeunePublicConverter cultureScientifiqueRecontreGrandPublicJeunePublicConverter;
    ...
    public List<CultureScientifiqueRecontreGrandPublicJeunePublicVo> findByCriteria(@RequestBody CultureScientifiqueRecontreGrandPublicJeunePublicVo cultureScientifiqueRecontreGrandPublicJeunePublicVo){
        return cultureScientifiqueRecontreGrandPublicJeunePublicConverter.toVo(cultureScientifiqueRecontreGrandPublicJeunePublicService.findByCriteria(cultureScientifiqueRecontreGrandPublicJeunePublicVo));
            ...
            public List<CultureScientifiqueRecontreGrandPublicJeunePublicVo> findByChercheurUsernameAndCampagneId(@PathVariable String username,@PathVariable Long compagneId){
            return cultureScientifiqueRecontreGrandPublicJeunePublicConverter.toVo(cultureScientifiqueRecontreGrandPublicJeunePublicService.findByChercheurUsernameAndCampagneId(username,compagneId));
            }
        }
