...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.StatutMasterConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.StatutMasterVo;

@Api("Manages statutMaster services")
@RestController
@RequestMapping("api/chercheur/statutMaster")
public class StatutMasterRestChercheur {
