...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.EcoleDoctoraleConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.EcoleDoctoraleVo;

@Api("Manages ecoleDoctorale services")
@RestController
@RequestMapping("api/chercheur/ecoleDoctorale")
public class EcoleDoctoraleRestChercheur {
