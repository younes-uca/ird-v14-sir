...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.FinancementDoctorantConverter;
...
private FinancementDoctorantConverter financementDoctorantConverter;
    ...
    public List<FinancementDoctorantVo> findAll(){
    	...
    	List<FinancementDoctorantVo>  fin = financementDoctorantConverter.toVo(financementDoctorantService.findAll());
