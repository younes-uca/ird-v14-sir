...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.ResponsabilitePedagogiqueEcoleDoctoraleConverter;
...
@RestController
@RequestMapping("api/chercheur/responsabilitePedagogiqueEcoleDoctorale")
public class ResponsabilitePedagogiqueEcoleDoctoraleRestChercheur {

@Autowired
private ResponsabilitePedagogiqueEcoleDoctoraleChercheurService responsabilitePedagogiqueEcoleDoctoraleService;
...
private ResponsabilitePedagogiqueEcoleDoctoraleConverter responsabilitePedagogiqueEcoleDoctoraleConverter;
    ...
    public List<ResponsabilitePedagogiqueEcoleDoctoraleVo> findByCriteria(@RequestBody ResponsabilitePedagogiqueEcoleDoctoraleVo responsabilitePedagogiqueEcoleDoctoraleVo){
        return responsabilitePedagogiqueEcoleDoctoraleConverter.toVo(responsabilitePedagogiqueEcoleDoctoraleService.findByCriteria(responsabilitePedagogiqueEcoleDoctoraleVo));
            ...
            public List<ResponsabilitePedagogiqueEcoleDoctoraleVo> findByChercheurUsernameAndCampagneId(@PathVariable String username,@PathVariable Long compagneId){
            return responsabilitePedagogiqueEcoleDoctoraleConverter.toVo(responsabilitePedagogiqueEcoleDoctoraleService.findByChercheurUsernameAndCampagneId(username,compagneId));
            }
        }
