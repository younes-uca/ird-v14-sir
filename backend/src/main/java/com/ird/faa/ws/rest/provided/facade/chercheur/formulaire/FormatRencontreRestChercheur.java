...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.FormatRencontreConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.FormatRencontreVo;

@Api("Manages formatRencontre services")
@RestController
@RequestMapping("api/chercheur/formatRencontre")
public class FormatRencontreRestChercheur {
