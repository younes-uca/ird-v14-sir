...
import com.ird.faa.service.chercheur.facade.formulaire.PubliquePrincipalChercheurService;
...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.PubliquePrincipalConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.PubliquePrincipalVo;

@Api("Manages publiquePrincipal services")
@RestController
@RequestMapping("api/chercheur/publiquePrincipal")
public class PubliquePrincipalRestChercheur {

@Autowired
private PubliquePrincipalChercheurService publiquePrincipalService;
