...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.EtablissementConverter;
...
public class EtablissementRestAdmin {
	...
	@PutMapping("/archiver/")
	public EtablissementVo archiver(@RequestBody EtablissementVo etablissementVo) {
		Etablissement etablissement = etablissementService.archiver(etablissementConverter.toItem(etablissementVo));
		return etablissementConverter.toVo(etablissement);
	}

	@PutMapping("/desarchiver/")
	public EtablissementVo desarchiver(@RequestBody EtablissementVo etablissementVo) {
		Etablissement etablissement = etablissementService.desarchiver(etablissementConverter.toItem(etablissementVo));
		return etablissementConverter.toVo(etablissement);
	}
}
