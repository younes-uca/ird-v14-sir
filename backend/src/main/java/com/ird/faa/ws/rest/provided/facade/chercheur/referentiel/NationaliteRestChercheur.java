...
import com.ird.faa.service.chercheur.facade.formulaire.NationaliteChercheurService;
...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.NationaliteConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.NationaliteVo;

@Api("Manages nationalite services")
@RestController
@RequestMapping("api/chercheur/nationalite")
public class NationaliteRestChercheur {

@Autowired
private NationaliteChercheurService nationaliteService;
