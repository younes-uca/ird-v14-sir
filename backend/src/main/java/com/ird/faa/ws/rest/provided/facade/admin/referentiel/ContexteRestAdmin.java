...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.ContexteConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.ContexteVo;

@Api("Manages contexte services")
@RestController
@RequestMapping("api/admin/contexte")
public class ContexteRestAdmin {
