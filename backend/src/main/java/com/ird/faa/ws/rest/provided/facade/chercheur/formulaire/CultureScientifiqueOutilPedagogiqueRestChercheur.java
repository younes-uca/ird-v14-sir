...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.CultureScientifiqueOutilPedagogiqueConverter;
...
@RestController
@RequestMapping("api/chercheur/cultureScientifiqueOutilPedagogique")
public class CultureScientifiqueOutilPedagogiqueRestChercheur {
...
private CultureScientifiqueOutilPedagogiqueConverter cultureScientifiqueOutilPedagogiqueConverter;
    ...
    public List<CultureScientifiqueOutilPedagogiqueVo> findByCriteria(@RequestBody CultureScientifiqueOutilPedagogiqueVo cultureScientifiqueOutilPedagogiqueVo){
        return cultureScientifiqueOutilPedagogiqueConverter.toVo(cultureScientifiqueOutilPedagogiqueService.findByCriteria(cultureScientifiqueOutilPedagogiqueVo));
            ...
            public List<CultureScientifiqueOutilPedagogiqueVo> findByChercheurUsernameAndCampagneId(@PathVariable String username,@PathVariable Long compagneId){
            return cultureScientifiqueOutilPedagogiqueConverter.toVo(cultureScientifiqueOutilPedagogiqueService.findByChercheurUsernameAndCampagneId(username,compagneId));
            }
        }
