...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.BourseConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.BourseVo;

@Api("Manages bourse services")
@RestController
@RequestMapping("api/admin/bourse")
public class BourseRestAdmin {

@Autowired
private BourseAdminService bourseService;
