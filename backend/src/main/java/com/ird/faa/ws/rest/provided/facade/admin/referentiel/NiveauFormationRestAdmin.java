...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.NiveauFormationConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.NiveauFormationVo;

@Api("Manages niveauFormation services")
@RestController
@RequestMapping("api/admin/niveauFormation")
public class NiveauFormationRestAdmin {

@Autowired
private NiveauFormationAdminService niveauFormationService;
