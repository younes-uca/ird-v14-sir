...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.TypeParticipationConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.TypeParticipationVo;

@Api("Manages typeParticipation services")
@RestController
@RequestMapping("api/admin/typeParticipation")
public class TypeParticipationRestAdmin {
