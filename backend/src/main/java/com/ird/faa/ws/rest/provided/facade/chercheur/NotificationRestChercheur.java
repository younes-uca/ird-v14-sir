...
import com.ird.faa.ws.rest.provided.converter.NotificationConverter;
...
@RestController
@RequestMapping("api/chercheur/notification")
public class NotificationRestChercheur {

@Autowired
private NotificationChercheurService notificationService;
