...
import com.ird.faa.ws.rest.provided.converter.TypeEnseignementDispenseConverter;
import com.ird.faa.ws.rest.provided.vo.TypeEnseignementDispenseVo;

@Api("Manages typeEnseignementDispense services")
@RestController
@RequestMapping("api/chercheur/typeEnseignementDispense")
public class TypeEnseignementDispenseRestChercheur {

@Autowired
private TypeEnseignementDispenseChercheurService typeEnseignementDispenseService;
