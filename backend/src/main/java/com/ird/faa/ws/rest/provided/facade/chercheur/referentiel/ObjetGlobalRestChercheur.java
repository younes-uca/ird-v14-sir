...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.ObjetGlobalConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.ObjetGlobalVo;

@Api("Manages objetGlobal services")
@RestController
@RequestMapping("api/chercheur/objetGlobal")
public class ObjetGlobalRestChercheur {

@Autowired
private ObjetGlobalChercheurService objetGlobalService;
