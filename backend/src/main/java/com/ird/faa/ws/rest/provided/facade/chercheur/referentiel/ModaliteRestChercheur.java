...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.ModaliteConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.ModaliteVo;

@Api("Manages modalite services")
@RestController
@RequestMapping("api/chercheur/modalite")
public class ModaliteRestChercheur {
