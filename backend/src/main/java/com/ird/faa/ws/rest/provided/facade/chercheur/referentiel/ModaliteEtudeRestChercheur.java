...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.ModaliteEtudeConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.ModaliteEtudeVo;

@Api("Manages modaliteEtude services")
@RestController
@RequestMapping("api/chercheur/modaliteEtude")
public class ModaliteEtudeRestChercheur {
