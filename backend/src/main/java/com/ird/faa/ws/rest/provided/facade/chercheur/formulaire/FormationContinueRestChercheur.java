...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.FormationContinueConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.FormationContinueVo;

@Api("Manages formationContinue services")
@RestController
@RequestMapping("api/chercheur/formationContinue")
public class FormationContinueRestChercheur {
