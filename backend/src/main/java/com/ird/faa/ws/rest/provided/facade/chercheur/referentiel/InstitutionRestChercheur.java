...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.InstitutionConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.InstitutionVo;

@Api("Manages institution services")
@RestController
@RequestMapping("api/chercheur/institution")
public class InstitutionRestChercheur {
