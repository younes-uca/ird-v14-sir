...
@RestController
@RequestMapping("api/chercheur/contratEtConventionIrd")
public class ContratEtConventionIrdRestChercheur {
	...
	@ApiOperation("Get contrats Chercheur")
	@GetMapping("/import/contracts/username/{username}")
	public Map<String, Object> getContrats(@PathVariable String username) {
		return contractImportService.updateOrAddContract(username);
	}
}
