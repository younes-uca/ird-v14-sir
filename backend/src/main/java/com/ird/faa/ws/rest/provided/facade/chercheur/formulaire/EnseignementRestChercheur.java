...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.EnseignementConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.EnseignementVo;

@Api("Manages enseignement services")
@RestController
@RequestMapping("api/chercheur/enseignement")
public class EnseignementRestChercheur {
