...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.DistinctionConverter;
...
public class DistinctionRestChercheur {
	...
	@ApiOperation("find by typeParticipation code")
	@GetMapping("/typeParticipation/code/{code}")
	public List<Distinction> findByTypeParticipationCode(@PathVariable String code) {
		return distinctionService.findByTypeParticipationCode(code);
	}

	@ApiOperation("delete by typeParticipation code")
	@DeleteMapping("/typeParticipation/code/{code}")
	public int deleteByTypeParticipationCode(@PathVariable String code) {
		return distinctionService.deleteByTypeParticipationCode(code);
	}

	@ApiOperation("find by typeParticipation id")
	@GetMapping("/typeParticipation/id/{id}")
	public List<Distinction> findByTypeParticipationId(@PathVariable Long id) {
		return distinctionService.findByTypeParticipationId(id);
	}

	@ApiOperation("delete by typeParticipation id")
	@DeleteMapping("/typeParticipation/id/{id}")
	public int deleteByTypeParticipationId(@PathVariable Long id) {
		return distinctionService.deleteByTypeParticipationId(id);
	}

	@ApiOperation("find by pays code")
	@GetMapping("/pays/code/{code}")
	public List<Distinction> findByPaysCode(@PathVariable String code) {
		return distinctionService.findByPaysCode(code);
	}

	@ApiOperation("delete by pays code")
	@DeleteMapping("/pays/code/{code}")
	public int deleteByPaysCode(@PathVariable String code) {
		return distinctionService.deleteByPaysCode(code);
	}

	@ApiOperation("find by pays id")
	@GetMapping("/pays/id/{id}")
	public List<Distinction> findByPaysId(@PathVariable Long id) {
		return distinctionService.findByPaysId(id);
	}

	@ApiOperation("delete by pays id")
	@DeleteMapping("/pays/id/{id}")
	public int deleteByPaysId(@PathVariable Long id) {
		return distinctionService.deleteByPaysId(id);
	}
	...
	public List<DistinctionVo> findByChercheurUsernameAndCampagneId(@PathVariable String username,
