...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.SavoirEtInnovationConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.SavoirEtInnovationVo;

@Api("Manages savoirEtInnovation services")
@RestController
@RequestMapping("api/chercheur/savoirEtInnovation")
public class SavoirEtInnovationRestChercheur {
...
private SavoirEtInnovationConverter savoirEtInnovationConverter;
    ...
    public List<SavoirEtInnovationVo> findByCriteria(@RequestBody SavoirEtInnovationVo savoirEtInnovationVo){
        ...
        return savoirEtInnovationService.deleteByEtatEtapeCampagneId(id);
            ...
            public SavoirEtInnovationVo findByChercheurUsernameAndCampagneId(@PathVariable String username,@PathVariable Long compagneId){
            return savoirEtInnovationConverter.toVo(savoirEtInnovationService.findByChercheurUsernameAndCampagneId(username,compagneId));
            }
