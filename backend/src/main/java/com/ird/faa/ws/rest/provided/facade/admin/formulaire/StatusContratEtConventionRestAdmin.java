...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.StatusContratEtConventionConverter;
...
@RestController
@RequestMapping("api/admin/statusContratEtConvention")
public class StatusContratEtConventionRestAdmin {
	...
	public StatusContratEtConventionVo update(@RequestBody StatusContratEtConventionVo statusContratEtConventionVo) {
		StatusContratEtConvention statusContratEtConvention = statusContratEtConventionConverter
				.toItem(statusContratEtConventionVo);
	...
	@PostMapping("/search")
	public List<StatusContratEtConventionVo> findByCriteria(
			@RequestBody StatusContratEtConventionVo statusContratEtConventionVo) {
		return statusContratEtConventionConverter
				.toVo(statusContratEtConventionService.findByCriteria(statusContratEtConventionVo));
	}
