...
import com.ird.faa.service.admin.facade.formulaire.InstrumentIrdConsultanceScientifiquePonctuelleAdminService;
import com.ird.faa.ws.rest.provided.converter.InstrumentIrdConsultanceScientifiquePonctuelleConverter;
...
@RestController
@RequestMapping("api/admin/instrumentIrdConsultanceScientifiquePonctuelle")
public class InstrumentIrdConsultanceScientifiquePonctuelleRestAdmin {

@Autowired
private InstrumentIrdConsultanceScientifiquePonctuelleAdminService instrumentIrdConsultanceScientifiquePonctuelleService;
