...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.DomaineScientifiqueConverter;
...
@RestController
@RequestMapping("api/chercheur/domaineScientifique")
public class DomaineScientifiqueRestChercheur {
