...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.EnjeuxIrdChercheurConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.EnjeuxIrdChercheurVo;

@Api("Manages enjeuxIrdChercheur services")
@RestController
@RequestMapping("api/chercheur/enjeuxIrdChercheur")
public class EnjeuxIrdChercheurRestChercheur {

@Autowired
private EnjeuxIrdChercheurChercheurService enjeuxIrdChercheurService;
