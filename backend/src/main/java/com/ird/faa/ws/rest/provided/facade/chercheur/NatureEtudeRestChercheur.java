...
import com.ird.faa.ws.rest.provided.converter.NatureEtudeConverter;
import com.ird.faa.ws.rest.provided.vo.NatureEtudeVo;

@Api("Manages natureEtude services")
@RestController
@RequestMapping("api/chercheur/natureEtude")
public class NatureEtudeRestChercheur {

@Autowired
private NatureEtudeChercheurService natureEtudeService;
