...
import com.ird.faa.service.chercheur.facade.formulaire.InstitutionCoContractantChercheurService;
...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.InstitutionCoContractantConverter;
...
@RestController
@RequestMapping("api/chercheur/institutionCoContractant")
public class InstitutionCoContractantRestChercheur {

@Autowired
private InstitutionCoContractantChercheurService institutionCoContractantService;
