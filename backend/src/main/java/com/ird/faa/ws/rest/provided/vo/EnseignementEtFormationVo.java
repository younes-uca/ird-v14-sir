...
public class EnseignementEtFormationVo {
    ...
    private List<ResponsabilitePedagogiqueVo> responsabilitePedagogiquesVo ;

    public EnseignementEtFormationVo(){
    super();
    }
        ...
        public List<ResponsabilitePedagogiqueVo> getResponsabilitePedagogiquesVo(){
        return this.responsabilitePedagogiquesVo;
        }

        public void setResponsabilitePedagogiquesVo(List<ResponsabilitePedagogiqueVo> responsabilitePedagogiquesVo){
            this.responsabilitePedagogiquesVo = responsabilitePedagogiquesVo;
            }
