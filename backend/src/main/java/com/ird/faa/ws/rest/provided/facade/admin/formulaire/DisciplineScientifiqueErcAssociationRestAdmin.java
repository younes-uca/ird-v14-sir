...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.DisciplineScientifiqueErcAssociationConverter;
...
@RestController
@RequestMapping("api/admin/disciplineScientifiqueErcAssociation")
public class DisciplineScientifiqueErcAssociationRestAdmin {
...
private DisciplineScientifiqueErcAssociationConverter disciplineScientifiqueErcAssociationConverter;
    ...
    public List<DisciplineScientifiqueErcAssociationVo> findByCriteria(@RequestBody DisciplineScientifiqueErcAssociationVo disciplineScientifiqueErcAssociationVo){
        ...
        return disciplineScientifiqueErcAssociationService.deleteBySemanticRelationshipId(id);
            ...
            @PutMapping("/archiver/")
            public DisciplineScientifiqueErcAssociationVo archiver(@RequestBody DisciplineScientifiqueErcAssociationVo disciplineScientifiqueErcAssociationVo){
                DisciplineScientifiqueErcAssociation disciplineScientifiqueErcAssociation = disciplineScientifiqueErcAssociationService.archiver(disciplineScientifiqueErcAssociationConverter.toItem(disciplineScientifiqueErcAssociationVo));
                return disciplineScientifiqueErcAssociationConverter.toVo(disciplineScientifiqueErcAssociation);
                }

            @PutMapping("/desarchiver/")
            public DisciplineScientifiqueErcAssociationVo desarchiver(@RequestBody DisciplineScientifiqueErcAssociationVo disciplineScientifiqueErcAssociationVo){
                DisciplineScientifiqueErcAssociation disciplineScientifiqueErcAssociation = disciplineScientifiqueErcAssociationService.desarchiver(disciplineScientifiqueErcAssociationConverter.toItem(disciplineScientifiqueErcAssociationVo));
                return disciplineScientifiqueErcAssociationConverter.toVo(disciplineScientifiqueErcAssociation);}
            }
