...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.DoctorantConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.DoctorantVo;

@Api("Manages doctorant services")
@RestController
@RequestMapping("api/chercheur/doctorant")
public class DoctorantRestChercheur {
