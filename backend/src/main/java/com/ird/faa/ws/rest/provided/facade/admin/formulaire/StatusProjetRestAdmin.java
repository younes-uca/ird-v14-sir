...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.StatusProjetConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.formulaire.StatusProjetVo;

@Api("Manages statusProjet services")
@RestController
@RequestMapping("api/admin/statusProjet")
public class StatusProjetRestAdmin {
