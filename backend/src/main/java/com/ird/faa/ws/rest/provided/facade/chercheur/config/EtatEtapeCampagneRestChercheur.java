...
import main.java.com.ird.faa.ws.rest.provided.converter.config.EtatEtapeCampagneConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.config.EtatEtapeCampagneVo;

@Api("Manages etatEtapeCampagne services")
@RestController
@RequestMapping("api/chercheur/etatEtapeCampagne")
public class EtatEtapeCampagneRestChercheur {
