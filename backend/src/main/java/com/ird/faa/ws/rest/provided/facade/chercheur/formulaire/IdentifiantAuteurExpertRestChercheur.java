...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.IdentifiantAuteurExpertConverter;
...
@RestController
@RequestMapping("api/chercheur/identifiantAuteurExpert")
public class IdentifiantAuteurExpertRestChercheur {
