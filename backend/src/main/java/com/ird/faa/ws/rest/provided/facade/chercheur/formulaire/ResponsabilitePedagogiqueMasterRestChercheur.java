...
import com.ird.faa.service.chercheur.facade.formulaire.ResponsabilitePedagogiqueMasterChercheurService;
...
import main.java.com.ird.faa.ws.rest.provided.converter.formulaire.ResponsabilitePedagogiqueMasterConverter;
...
@RestController
@RequestMapping("api/chercheur/responsabilitePedagogiqueMaster")
public class ResponsabilitePedagogiqueMasterRestChercheur {

@Autowired
private ResponsabilitePedagogiqueMasterChercheurService responsabilitePedagogiqueMasterService;
...
private ResponsabilitePedagogiqueMasterConverter responsabilitePedagogiqueMasterConverter;
    ...
    public List<ResponsabilitePedagogiqueMasterVo> findByCriteria(@RequestBody ResponsabilitePedagogiqueMasterVo responsabilitePedagogiqueMasterVo){
        return responsabilitePedagogiqueMasterConverter.toVo(responsabilitePedagogiqueMasterService.findByCriteria(responsabilitePedagogiqueMasterVo));
            ...
            public List<ResponsabilitePedagogiqueMasterVo> findByChercheurUsernameAndCampagneId(@PathVariable String username,@PathVariable Long compagneId){
            return responsabilitePedagogiqueMasterConverter.toVo(responsabilitePedagogiqueMasterService.findByChercheurUsernameAndCampagneId(username,compagneId));
            }
        }
