...
import main.java.com.ird.faa.ws.rest.provided.converter.config.EtatReclamationConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.config.EtatReclamationVo;

@Api("Manages etatReclamation services")
@RestController
@RequestMapping("api/chercheur/etatReclamation")
public class EtatReclamationRestChercheur {
