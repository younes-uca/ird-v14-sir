...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.PublicCibleConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.PublicCibleVo;

@Api("Manages publicCible services")
@RestController
@RequestMapping("api/chercheur/publicCible")
public class PublicCibleRestChercheur {
