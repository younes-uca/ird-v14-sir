...
import main.java.com.ird.faa.ws.rest.provided.converter.referentiel.StructureIrdConverter;
import main.java.com.ird.faa.ws.rest.provided.vo.referentiel.StructureIrdVo;

@Api("Manages structureIrd services")
@RestController
@RequestMapping("api/chercheur/structureIrd")
public class StructureIrdRestChercheur {
