...
public class IdentifiantRecherche implements Archivable {

@Id
    @SequenceGenerator(name="identifiant_recherche_seq",sequenceName="identifiant_recherche_seq",
    allocationSize=1, initialValue = 10000)
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator="identifiant_recherche_seq")
private Long id;
