...
@Service
public class ResponsabiliteDirectionEncadrementEtudiantAdminServiceImpl extends AbstractServiceImpl<ResponsabiliteDirectionEncadrementEtudiant> implements ResponsabiliteDirectionEncadrementEtudiantAdminService {
...
public List<ResponsabiliteDirectionEncadrementEtudiant> findAll(){
        return responsabiliteDirectionEncadrementEtudiantDao.findAll();
}
    @Override
...
public ResponsabiliteDirectionEncadrementEtudiant findByIdWithAssociatedList(Long id){
    ...
    @Override
    public ResponsabiliteDirectionEncadrementEtudiant archiver(ResponsabiliteDirectionEncadrementEtudiant responsabiliteDirectionEncadrementEtudiant) {
    if (responsabiliteDirectionEncadrementEtudiant.getArchive() == null) {
    responsabiliteDirectionEncadrementEtudiant.setArchive(false);
    }
    responsabiliteDirectionEncadrementEtudiant.setArchive(true);
    responsabiliteDirectionEncadrementEtudiant.setDateArchivage(new Date());
    responsabiliteDirectionEncadrementEtudiantDao.save(responsabiliteDirectionEncadrementEtudiant);
    return responsabiliteDirectionEncadrementEtudiant;

    }

    @Override
    public ResponsabiliteDirectionEncadrementEtudiant desarchiver(ResponsabiliteDirectionEncadrementEtudiant responsabiliteDirectionEncadrementEtudiant) {
    if (responsabiliteDirectionEncadrementEtudiant.getArchive() == null) {
    responsabiliteDirectionEncadrementEtudiant.setArchive(false);
    }
    responsabiliteDirectionEncadrementEtudiant.setArchive(false);
