...
@Service
public class ConsultanceScientifiquePonctuelleAdminServiceImpl extends AbstractServiceImpl<ConsultanceScientifiquePonctuelle> implements ConsultanceScientifiquePonctuelleAdminService {
