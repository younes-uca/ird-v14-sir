...
@Service
public class CampagneRelanceChercheurAdminServiceImpl extends AbstractServiceImpl<CampagneRelanceChercheur> implements CampagneRelanceChercheurAdminService {
