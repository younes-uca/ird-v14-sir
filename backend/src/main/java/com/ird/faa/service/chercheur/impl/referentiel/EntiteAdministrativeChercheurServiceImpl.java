...
@Service
public class EntiteAdministrativeChercheurServiceImpl extends AbstractServiceImpl<EntiteAdministrative> implements EntiteAdministrativeChercheurService {
