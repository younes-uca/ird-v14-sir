...
@Service
public class EnseignementDisciplineScientifiqueAdminServiceImpl extends AbstractServiceImpl<EnseignementDisciplineScientifique> implements EnseignementDisciplineScientifiqueAdminService {
