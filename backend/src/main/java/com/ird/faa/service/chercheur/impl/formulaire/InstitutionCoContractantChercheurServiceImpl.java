...
@Service
public class InstitutionCoContractantChercheurServiceImpl extends AbstractServiceImpl<InstitutionCoContractant> implements InstitutionCoContractantChercheurService {

@Autowired
private InstitutionCoContractantDao institutionCoContractantDao;

        @Autowired
        private InstitutionChercheurService institutionService ;
        @Autowired
