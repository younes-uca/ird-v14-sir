...
public interface FormationContinueCommanditaireChercheurService extends AbstractService<FormationContinueCommanditaire,Long,FormationContinueCommanditaireVo>{
