...
@Service
public class InstrumentsEtDispositifsIrdAdminServiceImpl extends AbstractServiceImpl<InstrumentsEtDispositifsIrd> implements InstrumentsEtDispositifsIrdAdminService {
