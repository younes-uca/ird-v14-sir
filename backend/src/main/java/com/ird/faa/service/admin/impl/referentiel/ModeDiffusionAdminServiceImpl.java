...
if(modeDiffusionDao.findById(id) == null) return 0;
else{
...
@Override
public List<List<ModeDiffusion>>  getToBeSavedAndToBeDeleted(List<ModeDiffusion> oldList,List<ModeDiffusion> newList){
