...
@Service
public class EnseignementZoneGeographiqueChercheurServiceImpl extends AbstractServiceImpl<EnseignementZoneGeographique> implements EnseignementZoneGeographiqueChercheurService {
