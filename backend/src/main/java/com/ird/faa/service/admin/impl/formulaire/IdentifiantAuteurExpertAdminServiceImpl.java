...
import com.ird.faa.dao.formulaire.IdentifiantAuteurExpertDao;
...
@Service
public class IdentifiantAuteurExpertAdminServiceImpl extends AbstractServiceImpl<IdentifiantAuteurExpert> implements IdentifiantAuteurExpertAdminService {
...
IdentifiantAuteurExpert identifiantAuteurExpert  = findById(id);
return identifiantAuteurExpert;
}


@Transactional
public int deleteById(Long id){
if(identifiantAuteurExpertDao.findById(id) == null) return 0;
else{
...
IdentifiantAuteurExpert savedIdentifiantAuteurExpert = identifiantAuteurExpertDao.save(identifiantAuteurExpert);
return savedIdentifiantAuteurExpert;
}

@Override
public List<IdentifiantAuteurExpert> save(List<IdentifiantAuteurExpert> identifiantAuteurExperts){
List<IdentifiantAuteurExpert> list = new ArrayList<IdentifiantAuteurExpert>();
...
@Override
public List<List<IdentifiantAuteurExpert>>  getToBeSavedAndToBeDeleted(List<IdentifiantAuteurExpert> oldList,List<IdentifiantAuteurExpert> newList){
