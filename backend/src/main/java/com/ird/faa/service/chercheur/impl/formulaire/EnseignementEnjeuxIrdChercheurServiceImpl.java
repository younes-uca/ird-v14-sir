...
@Service
public class EnseignementEnjeuxIrdChercheurServiceImpl extends AbstractServiceImpl<EnseignementEnjeuxIrd>
		implements EnseignementEnjeuxIrdChercheurService {
	...
	public EnseignementEnjeuxIrd update(EnseignementEnjeuxIrd enseignementEnjeuxIrd) {
		...
		if (foundedEnseignementEnjeuxIrd == null)
			return null;
		else {
	...
	public int delete(EnseignementEnjeuxIrd enseignementEnjeuxIrd) {
		if (enseignementEnjeuxIrd.getId() == null)
			return -1;
		EnseignementEnjeuxIrd foundedEnseignementEnjeuxIrd = findById(enseignementEnjeuxIrd.getId());
		if (foundedEnseignementEnjeuxIrd == null)
			return -1;
