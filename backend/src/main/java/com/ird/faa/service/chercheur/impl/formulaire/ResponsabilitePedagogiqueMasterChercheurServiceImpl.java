...
@Service
public class ResponsabilitePedagogiqueMasterChercheurServiceImpl extends AbstractServiceImpl<ResponsabilitePedagogiqueMaster> implements ResponsabilitePedagogiqueMasterChercheurService {
...
private ResponsabilitePedagogiqueMasterDao responsabilitePedagogiqueMasterDao;
        ...
        @Autowired
        private StatutMasterChercheurService statutMasterService ;
        @Autowired
...
if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
    return responsabilitePedagogiqueMasterDao.findByChercheurUsername(currentUser.getUsername());
    }
...
ResponsabilitePedagogiqueMaster resultat = new ResponsabilitePedagogiqueMaster();
...
return resultat;
    ...
    responsabilitePedagogiqueMaster.setCampagne(laodedCampagne);
...
List<ResponsabilitePedagogiqueMaster> resultat= responsabilitePedagogiqueMasterDao.findByChercheurUsernameAndCampagneId(username, compagneId);
    return resultat;
}
