...
import com.ird.faa.service.chercheur.facade.formulaire.StructureIrdChercheurService;
...
import com.ird.faa.service.chercheur.facade.formulaire.VieInstitutionnelleDetailEtablissementChercheurService;
import com.ird.faa.service.chercheur.facade.formulaire.VieInstitutionnelleDetailInstrumentIrdChercheurService;
...
private VieInstitutionnelleDetailDao vieInstitutionnelleDetailDao;
        ...
        @Autowired
        private TypeInstanceChercheurService typeInstanceService ;
        @Autowired
        private VieInstitutionnelleChercheurService vieInstitutionnelleService ;
        @Autowired
        private VieInstitutionnelleDetailInstrumentIrdChercheurService vieInstitutionnelleDetailInstrumentIrdService ;
        @Autowired
        private StructureIrdChercheurService structureIrdService ;
        @Autowired
        private PaysChercheurService paysService ;
        @Autowired
        private VieInstitutionnelleDetailEtablissementChercheurService vieInstitutionnelleDetailEtablissementService ;
...
public void update(List<VieInstitutionnelleDetail> vieInstitutionnelleDetails){
	if(ListUtil.isNotEmpty(vieInstitutionnelleDetails)){
		vieInstitutionnelleDetails.forEach(
				e->{
				if(e.getId()!=null) {
					update(e);
				}else {
