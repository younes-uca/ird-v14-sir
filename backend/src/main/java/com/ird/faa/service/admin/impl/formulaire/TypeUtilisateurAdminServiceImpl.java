...
if(typeUtilisateurDao.findById(id) == null) return 0;
else{
...
@Override
public List<List<TypeUtilisateur>>  getToBeSavedAndToBeDeleted(List<TypeUtilisateur> oldList,List<TypeUtilisateur> newList){
